...
def sonar(Map step_params) {
    stage('Static Code Analysis') {
        ...
        def codebase_to_scan_directory = "${step_params.codebase_to_scan_directory}"
        def static_code_analysis_check = "${step_params.static_code_analysis_check}"
        def path_to_sonar_properties = "${step_params.path_to_sonar_properties}"
        def fail_job_if_analysis_returned_exception = "${step_params.fail_job_if_analysis_returned_exception}"
        def jenkins_sonarqube_token_creds_id = "${step_params.jenkins_sonarqube_token_creds_id}"
        def app_stack = "${step_params.app_stack}"
        def unit_testing_check = "${step_params.unit_testing_check}"
